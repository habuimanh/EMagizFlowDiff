...
export class Transformer extends React.Component<{ highlightedId: string, data: I.ITransformer }, {}>{
    render() {
        let style = {
            ...
            <div style={style}>
                <svg width={style.width + 4} height={style.height + 4}>
                    {this.props.data.guid === this.props.highlightedId ?
                        <rect x="2" y="2" rx="5" ry="5" width="80" height="60" fill="rgb(24, 46, 128)" style={{ stroke: "#ffa500", strokeWidth: 2 }} ></rect> :
                        <rect x="2" y="2" rx="5" ry="5" width="80" height="60" fill="rgb(24, 46, 128)"></rect>
                    }
